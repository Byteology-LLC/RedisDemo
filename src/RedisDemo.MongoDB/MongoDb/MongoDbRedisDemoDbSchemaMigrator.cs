...
public class MongoDbRedisDemoDbSchemaMigrator : IRedisDemoDbSchemaMigrator, ITransientDependency
{
    private readonly IServiceProvider _serviceProvider;

    public MongoDbRedisDemoDbSchemaMigrator(IServiceProvider serviceProvider)
    {
